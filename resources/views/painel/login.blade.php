    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style='background-image: url("assets/imagens/fundo_novo.webp");background-repeat: repeat-x;'>
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
                        <span><img src="{{ url ('assets/imagens/logo.png') }}" width="250px" /></span>
                        <h5 class="font-medium mb-3"><br>Sistema Mutua</h5>
                        @if($errors->all())
                        ...
                        <div class="col-12">
                            <form class="form-horizontal mt-3" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" placeholder="CPF" name="usuario" id="usuario">
                                </div>
                                <div class="input-group mb-3">
                                ...
                                <div class="d-flex justify-content-between mb-3">
                                    <div class="col-6 pb-3">
                                        <button class="btn d-block btn-lg btn-danger" type="submit">
                                            <i class="fab fa-brands fa-google-plus fs-7"></i>    
                                        Google</button>
                                    </div>

                                    <div class="col-5 pb-3">
                                        <button class="btn d-block btn-lg btn-info w-100" type="submit">
                                        <i class="fab fa-brands fa-facebook fs-6"></i>
                                        Facebook</button>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 text-center">
                                    ...
                                    <div class="col-xs-12 pb-3">
                                        <span>Não e Associoado? <a href="">Associe-se!</a></span>
                                    </div>
                                </div>
                            </form>
                        </div>
